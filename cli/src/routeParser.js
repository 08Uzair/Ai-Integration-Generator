/**
 * Extracts endpoints from a route/controller .txt file (or any source file).
 * Shared with the wizard frontend (frontend/lib/routeParser.js).
 * Supports:
 ...
 */
const CALL_RE =
  /\b(?:router|route|app|server|api)\.(get|post|put|patch|delete|options|head)\s*\(\s*[`'"](\/?(?:[^`'"]*))[`'"]/gi;
